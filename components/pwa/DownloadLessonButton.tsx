...
export function DownloadLessonButton({
  ...
  if (downloaded) {
    return (
      <button
        ...
        disabled={loading}
        className={cn(
          "flex items-center gap-1.5 rounded-lg border border-green-200 bg-green-50 px-3 py-1.5 text-xs font-medium text-green-700 hover:bg-red-50 hover:border-red-200 hover:text-red-600 transition-colors group",
          compact && "px-2 py-1",
          className
        )}
  ...
  return (
    <button
      ...
      disabled={loading}
      className={cn(
        "flex items-center gap-1.5 rounded-lg border border-brand-200 bg-white px-3 py-1.5 text-xs font-medium text-brand-700 hover:bg-brand-50 transition-colors disabled:opacity-50",
        compact && "px-2 py-1",
        className
      )}
    >
